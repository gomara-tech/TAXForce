...
public class CertidaoNegativaAL extends BasePage {

	static WebDriver driver;

	public static final Logger log = (Logger) LoggerFactory.getLogger(CertidaoNegativaAL.class);
	...
	public void Home() throws Exception {
		...
		try {
			...
			driver.get("http://contribuinte.sefaz.al.gov.br/");
