...
public class CertidaoNegativaAM extends BasePage {

	static WebDriver driver;

	public static final Logger log = (Logger) LoggerFactory.getLogger(CertidaoNegativaAM.class);
	...
	public void Home() throws Exception {
		...
		try {
			...
			driver.get("https://online.sefaz.am.gov.br");
