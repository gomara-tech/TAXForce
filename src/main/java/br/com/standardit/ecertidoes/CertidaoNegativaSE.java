...
public class CertidaoNegativaSE extends BasePage {

	static WebDriver driver;

	public static final Logger log = (Logger) LoggerFactory.getLogger(CertidaoNegativaSE.class);
	...
	public void Home() throws Exception {
		...
		try {
			...
			driver.get("http://www.sefaz.se.gov.br/conteudo/63");
			...
			waitResult = utilAut.WaitFor(10, new String[] { "ECertidoes\\SE\\ClickEmCnpj.png" });
			if (waitResult.region != null) {
				waitResult.region.click();
			}

			waitResult = utilAut.WaitFor(10, new String[] { "ECertidoes\\SE\\InsereCNPJ.png" });
			if (waitResult.region != null) {
				waitResult.region.click();
				s.type("11222333000122");
			}

			waitResult = utilAut.WaitFor(10, new String[] { "ECertidoes\\SE\\BotaoOk.png" });
			if (waitResult.region != null) {
				waitResult.region.click();
			}
