package br.com.standardit.captcha;
...
public class TwoCaptchaDotComSolver {
	static String key = "a5b676671c3d9cb4bee13db5b94aa42e";
  
	public static void main(String[] args) throws Exception {
        File file = new File("T:\\Service001\\Processar\\imgCaptchaSerpro.png"); 
        System.out.println(solveCaptcha(file));
    }
     ...
     * @throws Exception
     */
    public static String solveCaptcha(File file) throws Exception{
        ...
        if(ret!=null){
            if(ret.startsWith("OK")){
                ...
                if(captchaSolved.startsWith("OK")){
                	...
                	System.out.println("Variavel captchaSolved: " + captchaSolved);
                    throw new Exception(captchaSolved);
                }
            }else{
            	System.out.println("Variavel ret:" + ret);
    ...
    private static String getId(String key, File file) throws Exception {
        ...
        //builder.addTextBody("regsense", "1");
